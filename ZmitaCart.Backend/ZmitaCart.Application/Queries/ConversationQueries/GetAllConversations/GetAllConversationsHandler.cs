...
public class GetAllConversationsHandler : IRequestHandler<GetAllConversationsQuery, Result<IEnumerable<ConversationInfoDto>>>
{
	...
	public async Task<Result<IEnumerable<ConversationInfoDto>>> Handle(GetAllConversationsQuery request, CancellationToken cancellationToken)
	{
