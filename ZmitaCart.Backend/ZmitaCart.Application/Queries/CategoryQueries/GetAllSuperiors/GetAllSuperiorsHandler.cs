...
public class GetAllSuperiorsHandler : IRequestHandler<GetAllSuperiorsQuery, IEnumerable<SuperiorCategoryDto>>
{
	...
	public async Task<IEnumerable<SuperiorCategoryDto>> Handle(GetAllSuperiorsQuery request, CancellationToken cancellationToken)
	{
